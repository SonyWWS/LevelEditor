    ...
    public class ArcBallCameraController : CameraController
    {
        ...
        public override bool MouseMove(object sender, MouseEventArgs e)
        {
                ...
                InputScheme.ActiveControlScheme.IsControllingCamera(Control.ModifierKeys, e))
            {
                ...
                if (InputScheme.ActiveControlScheme.IsRotating(Control.ModifierKeys, e) &&
                ...
                else if (InputScheme.ActiveControlScheme.IsZooming(Control.ModifierKeys, e))
                {
                    float zoom = (-dy - dx);
                ...
                else if (InputScheme.ActiveControlScheme.IsPanning(Control.ModifierKeys, e))
                {
