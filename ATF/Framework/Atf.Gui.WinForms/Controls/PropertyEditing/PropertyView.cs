...
namespace Sce.Atf.Controls.PropertyEditing
{
    ...
    public abstract class PropertyView : Control, IPropertyEditingControlOwner
    {
        ...
        /// <summary>
        /// Bold version of the control's font</summary>
        ...
        /// <summary>
        /// Performs custom actions and raises the <see cref="E:System.Windows.Forms.Control.MarginChanged"></see> event</summary>
        /// <param name="e">An <see cref="T:System.EventArgs"></see> that contains the event data</param>
        /// <remarks>When overriding, call the base method to create fonts and force a re-layout</remarks>
        ...
        {
            RowHeight = base.FontHeight + Margin.Top;
        }

        /// <summary>
        /// Cached Font height</summary>
        ...
        private void observableContext_Reloaded(object sender, EventArgs e)
        {
            ...
            if (context != null)
            {
                ...
                {
                    Invalidate();
                    WinFormsUtil.InvokeIfRequired(this, () => { RefreshEditingControls(); });
                }
        ...
        private Property BuildProperty(PropertyDescriptor descriptor, int index)
        {
            ...
            if (control == null)
            {
                // grid view overrides this to return a PropertyEditingControl in the default case
                control = GetEditingControl(property);
                if (control != null)
                {
        ...
        protected virtual Control GetEditingControl(Property property)
        {
            ...
            IPropertyEditor editor = property.Descriptor.GetEditor(typeof(IPropertyEditor)) as IPropertyEditor;
            if (editor != null)
                control = editor.GetEditingControl(property.Context);
        ...
        /// <summary>
        /// Left justified string format</summary>
        protected static StringFormat LeftStringFormat;

        /// <summary>
        /// Right justified string format</summary>
